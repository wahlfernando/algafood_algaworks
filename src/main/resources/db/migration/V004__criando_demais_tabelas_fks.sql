create table forma_pagamento (id bigint not null auto_increment, descricao varchar(60) not null, primary key (id)) engine=InnoDB default charset=utf8;
...
alter table grupo_permissao add constraint FK_grupo_permissao_permisao foreign key (permissao_id) references permissao (id);
