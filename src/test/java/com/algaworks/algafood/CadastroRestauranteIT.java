...
public class CadastroRestauranteIT {
    ...
    public void setUp() {
        ...
        jsonRestauranteCorreto = ContenteFromResources.getContentFromResource(
                "/jsons/restaurante-new-york-barbecue.json");
        
        jsonRestauranteSemFrete = ContenteFromResources.getContentFromResource(
                "/jsons/restaurante-new-york-barbecue-sem-frete.json");
        
        jsonRestauranteSemCozinha = ContenteFromResources.getContentFromResource(
                "/jsons/restaurante-new-york-barbecue-sem-cozinha.json");
        
        jsonRestauranteComCozinhaInexistente = ContenteFromResources.getContentFromResource(
                "/jsons/restaurante-new-york-barbecue-com-cozinha-inexistente.json");
