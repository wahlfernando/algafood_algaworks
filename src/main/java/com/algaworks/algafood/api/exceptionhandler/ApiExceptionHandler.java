...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Override 4: handleExceptionInternal (assinatura mudou HttpStatus ->
    // HttpStatusCode)
    @Override
...
// import
// com.algaworks.algafood.domain.exception.EntidadeNaoEncontradaException;
...
// WebRequest request) {
// return handleValidationInternal(ex, ex.getBindingResult(), headers, status,
// request);
// }
// @Override
...
// request);
// }
// private Problem getProblem(HttpStatus status, ProblemType problemType, String
// detail, BindingResult bindingResult) {
...
// public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest
// request) {
...
// String detail = "O recurso %s, que você tentou acessar, é
// inexistente.".formatted(
// ex.getRequestURL());
// Problem problem = createProblemBuilder(status, problemType, detail)
...
// String detail = "O corpo da requisição está inválido. Verifique erro de
// sintaxe.";
// Problem problem = createProblemBuilder(status, problemType, detail)
// .userMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
// .build();
// return handleExceptionInternal(ex, problem, headers, status, request);
// }
// private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException
// ex,
// HttpHeaders headers, HttpStatus status, WebRequest request) {
...
// handleEntidadeNaoEncontrada(EntidadeNaoEncontradaException ex,
// WebRequest request) {
...
// public ResponseEntity<?> handleNegocio(NegocioException ex, WebRequest
// request) {
